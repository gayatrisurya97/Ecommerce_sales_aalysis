...
Designed Top 10 analysis for:
Categories by Total Profit
Cities by Total Profit
Built calculated classifications (High Value / Low Value segmentation).
Created interactive Power BI visuals with Top N filters.

Developed KPI metrics including:
Total Sales
Total Profit
...
Data Transformation for BI Reporting
Business Insights Generated
Identified high-profit categories contributing most to revenue.
Highlighted top-performing cities driving overall profitability.
